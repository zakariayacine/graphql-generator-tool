...
<body>
    ...
    <a href="/table/show" class="btn btn-success">Retour vers la liste</a>
            ...
            <form name="add_column" id="add_column">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dynamic_field">
                        ...
                        <tr>
                            <td colspan="3"><input type="text" name="table" placeholder="Enter table Name"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var postURL = "<?php echo url('store'); ?>";
